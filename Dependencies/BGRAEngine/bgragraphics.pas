...
{$IFDEF BGRABITMAP_USE_MSEGUI}
  {$i bgramsegui_uses.map.inc}
{$ELSE}
  {$IFDEF BGRABITMAP_USE_FPGUI}
    {$i bgrafpgui_uses.map.inc}
  {$ELSE}
    {$i bgranogui_uses.map.inc}
  {$ENDIF}
{$ENDIF}
